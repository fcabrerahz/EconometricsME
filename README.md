...
**Laboratorio**: Moisés Barranco Juárez
[moises.barranco\@alumnos.cide.edu](mailto:moises.barranco@alumnos.cide.edu)

**Horario de Clase:** lunes y jueves de 9:40 a 11.10 horas.  
**Horario de Laboratorio:** Por definirse.  


**Objetivo General:**
El objetivo del curso es dotar al alumno de las herramientas teóricas y prácticas necesarias para comprender y aplicar las técnicas econométricas más usuales en el análisis de la relación entre variables económicas. 
...
*No hay libro de texto obligatorio, pero la teoría que guía el curso se fundamenta en Hansen. Las demás referencias son muy útiles para complementar el conocimiento, en especial, Hayashi.*
...
- Los ejercicios desarrollados en los laboratorios (seis en el semestre), que contribuyen al 20% de la calificación total. *Los laboratorios tendrán un valor en la calificación únicamente si se entregan completos en la fecha y horario estipulados.* 
- Un trabajo final en el que los estudiantes aplicarán algunos de los conocimientos desarrollados en clase a datos de México y que contribuye al 20% restante de la calificación final.
- Se realizarán lecturas obligatorias para su discusión en sesiones tipo seminario, sin ponderación en la calificación final. 
...
**Avance 1 proyecto final y discusión de la primera lectura obligatoria** (2 sesiones).
...
**Avance 2 proyecto final** (1 sesión).
...
${\color{red}\text{Examen Final (Segunda semana de junio)}}$

${\color{red}\text{Entrega Proyecto Final (Segunda semana de junio)}}$
